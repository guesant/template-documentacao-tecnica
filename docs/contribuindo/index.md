...
Esta aba é para quem escreve ou revisa documentação, não para quem só está
consultando. Aqui ficam as regras: por que a estrutura é assim, qual voz e
tom usar, quais convenções de escrita seguir e como escrever uma página
nova.
...
Nada aqui foi inventado do zero. Assim como um artigo acadêmico revisa e
credita a literatura em que se apoia, este guia sintetiza, em português e
com paráfrase própria, nunca cópia, frameworks e guias de estilo já
publicados e amplamente adotados: [Diátaxis](referencias.md#diataxis), os
guias de estilo de [Google](referencias.md#google-style),
...
- [Por que a documentação é organizada em quatro tipos](diataxis.md): o
  raciocínio estrutural (Diátaxis).
- [Voz e tom](voz-e-tom.md): a personalidade da escrita, com exemplos de
  antes e depois.
- [Convenções de escrita](convencoes-de-escrita.md): regras objetivas,
  com níveis de obrigatoriedade (DEVE, DEVERIA, PODE).
- [Como escrever uma página de documentação](como-escrever-documentacao.md):
  passo a passo prático, com checklist de autorrevisão.
